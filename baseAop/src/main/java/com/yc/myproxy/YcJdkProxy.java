...
public class YcJdkProxy {
    ...
    public static Object newProxyInstance(YcClassLoader classLoader, Class<?>[] interfaces, YcInvocationHandler h) {
        try {
            //1.动态生成源代码.java文件
    ...
    /**
     * 针对这个接口拼装了一个java实现类，在这个类对抽象方法做实现
     *      伪代码:
     *          1.首先利用ribbon，访问eureka服务器得到服务列表，自动利用负载均衡获取一个服务
